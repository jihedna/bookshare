        ...
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <form action="{{ route('admin.categories.update', $category->getId()) }}" method="POST">
                ...
                <div class="mb-4 max-w-md">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $category->getName()) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                    @error('name')
                ...
                <div class="mb-4">
                    <p class="text-sm text-gray-600">
                        Cette catégorie est associée à {{ $category->getBooks()->count() }} livre(s).
                    </p>
                </div>
