...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Partagez un livre de votre collection avec la communauté</p>
        </div>
            ...
            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="5"
                        class="input w-full @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center">
                        <div class="w-24 h-32 bg-gray-100 rounded-md mr-4 flex items-center justify-center text-gray-400">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500 mt-1">Format JPG, PNG ou GIF. Max 2MB.</p>
                        </div>
                    </div>
                    @error('cover')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('books.index') }}" class="btn bg-gray-100 text-gray-700 hover:bg-gray-200">
                        Annuler
                    </a>
